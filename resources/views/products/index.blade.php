                ...
                <div class="p-1 col-md-4">
                    <div class="card">
                        @if ($api_product['produto']['imageThumbnail'] != null)
                            <img src="{{ $api_product['produto']['imageThumbnail'] }}" class="card-img-top"
                                alt="Product Image">
                        @else
                        ...
                        <div class="card-body">
                            ...
                            <form id="{{ $api_product['produto']['id'] }}" action="{{ route('products.store') }}"
                                ...
                                <input type="hidden" name="descricao"
                                    value="{{ $api_product['produto']['descricao'] }}">
                                ...
                                <input type="hidden" name="precoCusto"
                                    value="{{ $api_product['produto']['precoCusto'] }}">
                                ...
                                <input type="hidden" name="garantia"
                                    value="{{ $api_product['produto']['garantia'] }}">
                                ...
                                <input type="hidden" name="pesoBruto"
                                    value="{{ $api_product['produto']['pesoBruto'] }}">
                                ...
                                <input type="hidden" name="condicao"
                                    value="{{ $api_product['produto']['condicao'] }}">
                                <input type="hidden" name="freteGratis"
                                    value="{{ $api_product['produto']['freteGratis'] }}">
                                <input type="hidden" name="producao"
                                    value="{{ $api_product['produto']['producao'] }}">
